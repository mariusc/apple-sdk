...
<
  RLALocalDevicePrivateAPI,
  RLABluetoothListenerDelegate,
  RLASensorDelegate
>
...
@property (nonatomic, strong, readwrite)
  RLABluetoothServiceListenerManager* RLA_manager;
...
@property (nonatomic, copy, readwrite)
  void (^RLA_writeHandler)(CBPeripheral* ,CBCharacteristic*, NSError*);
...
- (instancetype)initWithPeripheral:(CBPeripheral *)peripheral
  andListenerManager:(RLABluetoothServiceListenerManager*)manager;
{
