 ...
 *
 *  @abstract A class to provides means to execute bluetooth requests of the users phone.
 *  @discussion This class is not supposed to be used. When you need to make requests, use a specific subclass instead.
 */
