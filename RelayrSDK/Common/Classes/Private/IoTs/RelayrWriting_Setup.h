#import "RelayrWriting.h"    // Parent class
 ...
 */
@interface RelayrWriting () <NSCoding>

/*!
 *  @abstract Designated initialiser for <code>RelayrWriting</code> objects.
 *
 *  @param meaning Relayr identifier for the type of output you are sending to the device (sensor).
 *	@return Fully initialised <code>RelayrWriting</code> object or <code>nil</code> if there were problems.
 */
 ...
 *
 *  @param output The newly <code>RelayrWriting</code> instance.
 */
