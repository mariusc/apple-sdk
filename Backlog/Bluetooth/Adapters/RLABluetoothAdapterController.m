...
#import "RLASensorAccelerometer.h"
#import "RLASensorColor.h"
#import "RLASensorGyroscope.h"
#import "RLASensorHumidity.h"
#import "RLASensorLuminosity.h"
#import "RLASensorNoise.h"
#import "RLASensorProximity.h"
#import "RLASensorTemperature.h"

#import "RLAOutputGrove.h"
#import "RLAOutputInfrared.h"
...
- (NSArray*)setupAcceptedPeripherals
{
    ...
    NSArray* peripherals = @[
        @{
            ...
            @"mappings"      : @[
                [[RLAMappingInfo alloc] initWithSensorClass:[RLASensorColor class] adapterClass:[RLABluetoothAdapterSensorColor class] serviceUUIDs:services characteristicUUIDs:characteristics],
                [[RLAMappingInfo alloc] initWithSensorClass:[RLASensorProximity class] adapterClass:[RLABluetoothAdapterSensorProximity class] serviceUUIDs:services characteristicUUIDs:characteristics]
            ]
         },
         @{
            @"name"          : @"WunderbarGYRO",
            ...
            @"mappings"      : @[
                [[RLAMappingInfo alloc] initWithSensorClass:[RLASensorGyroscope class] adapterClass:[RLABluetoothAdapterSensorGyroscope class] serviceUUIDs:services characteristicUUIDs:characteristics],
                [[RLAMappingInfo alloc] initWithSensorClass:[RLASensorAccelerometer class] adapterClass:[RLABluetoothAdapterSensorAccelerometer class] serviceUUIDs:services characteristicUUIDs:characteristics]
            ]
         },
         @{
            @"name"          : @"WunderbarHTU",
            ...
            @"mappings"      : @[
                [[RLAMappingInfo alloc] initWithSensorClass:[RLASensorTemperature class] adapterClass:[RLABluetoothAdapterSensorTemperature class] serviceUUIDs:services characteristicUUIDs:characteristics],
                [[RLAMappingInfo alloc] initWithSensorClass:[RLASensorHumidity class] adapterClass:[RLABluetoothAdapterSensorHumidity class] serviceUUIDs:services characteristicUUIDs:characteristics] ]
         },
         @{
            @"name"          : @"WunderbarMIC",
            @"bleIdentifier" : @"",
            ...
            @"mappings"      : @[
                [[RLAMappingInfo alloc] initWithSensorClass:[RLASensorNoise class] adapterClass:[RLABluetoothAdapterSensorNoise class] serviceUUIDs:services characteristicUUIDs:characteristics] ]
         },
         // Outputs
         @{
            @"name"          : @"WunderbarBRIDG",
            ...
            @"mappings"      : @[ [[RLAMappingInfo alloc] initWithOutputClass:[RLAOutputGrove class]] ],
         },
         @{
            @"name"          : @"WunderbarIR",
            @"bleIdentifier" : @"",
            @"relayrModelID" : @"bab45b9c-1c44-4e71-8e98-a321c658df47",
            @"mappings"      : @[ [[RLAMappingInfo alloc] initWithOutputClass:[RLAOutputInfrared class]] ],
         }
    ];
