...
/*!
 * @brief All possible functions that can be performed on a CString are listed here.
 * @details You access the functions through the constant global object "cstring".
 */
struct CStringFunctionality
{
    /*!
     * @brief C's null-character ('\0').
     */
    char const nullchar;
    
    /*!
     * @brief CString 0-length/allocated_length.
     * @details All the members of CStrings are initialised to 0.
     */
    CString const nullCString;
    
    /*!
     * @brief It initialises a new CString with the values of another CString.
...
//    /*!
//     * @brief It allocates space for the CString object in the heap.
//     */
//    CObjString* (* const alloc)(void);
//    
//    /*!
//     * @brief It initializes a CString with the by-default parameters: core.actives=1, core.type=COBJ_TYPE_STRING, length=0, chars=NULL.
//     */
//    CString* (* const init)(CString* const restrict str);
//    
//    /*!
//     * @brief It creates a CObjString, allocating space in the heap and initializing the object with the default values.
//     * @details Check the init() function for the default values.
//     */
//    CObjString* (* const create)(void);
//    
//    /*!
//     * @brief It creates a CObjString, allocating space in the heap and initialization the object to point to the passed string (char array).
//     */
//    CObjString* (* const create_with)(char const* const restrict string);
//    
//    /*!
//     * @brief It creates a CObjString, allocating space in the heap and initializing the object with the lenght and characters given.
...
//    /*!
//     * @brief It adds one to the reference counting number (only for heap objects).
...
//    /*!
//     * @brief It substracts one to the reference counting number (only for heap objects).
...
//    /*!
//     * @brief It creates a new CObjString with the exact content of a CString.
//     * @param str If NULL, NULL is returned.
//     */
//    CObjString* (* const clone)(CString const* const restrict str);
//    /*!
//     * @brief It creates a new CObjString with the content of the merged content of the first and second CStrings.
...
//    /*!
//     * @brief It creates a new CObjString with the content of the "to_prepend" and "base" (in that order).
//     * @details The null character of "to_prepend" is removed, so the two strings can be merged.
...
//    /*!
//     * @brief It appends the number of chars specified by max_length in the string array passed as parameter into the base CString.
...
//    /*!
//     * @brief It preprends the number of chars specified by max_length to base into a newly created CString object.
...
//    /*!
//     * @brief It appends the content of the second CString to the base CString, with the delimiter specified as an argument between them. Escaping characters is NOT allowed.
...
//    /*!
//     * @brief It prepends the content of the second CString to the base CString, with the delimiter specified as an argument between them. Escaping characters is NOT allowed.
//     * @details If the delimiter is already specified in the base or in the second CString, it is not added.
//     * @param base If NULL, it returns NULL.
//     * @param to_add If NULL, it returns NULL.
...
//    /*!
//     * @brief It compares the content of "str_a" with the content of "str_b". If they are exactly the same chars, "true" is returned. Also, if both of the arguments are NULL, "true" is returned.
...
/*!
 * @brief Global object enumerating all possible functions that can be performed on a CString object.
